        ...
        {!isCartEmpty && (
          <div className="sticky bottom-0 p-2 lg:p-3">
            ...
            <Link
              to="/cart"
              onClick={closeCart}
              className="w-full flex items-center justify-center gap-2 mt-3 text-sm font-semibold px-4 py-2 text-gray-400 rounded-lg transition-colors duration-300 hover:text-gray-800 hover:bg-gray-200">
