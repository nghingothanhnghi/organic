    ...
    return (
        <div className="relative">
            ...
            >
                ...
                {buttonLabel}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-3 ms-2 transition-transform transform ${isActive ? 'rotate-180' : ''}`}>
