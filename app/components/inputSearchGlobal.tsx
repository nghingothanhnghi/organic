    ...
    return (
        <form className="max-w-md mx-auto hidden lg:flex">
            <div className="relative">
                <input type="search" className="block w-full py-2 ps-3 pe-10 text-sm text-gray-900 border border-gray-200 rounded-full bg-gray-200" placeholder="Search Posts, Products..." required />
