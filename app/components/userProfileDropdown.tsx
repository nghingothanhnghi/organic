...
const UserProfileDropdown: React.FC = () => {
    ...
    return (
        <div className="relative">
            ...
            <div
                className={`dropdown pb-2 absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-lg z-10 transition-all duration-300 ease-in-out ${isActive ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}
            >
                ...
                <a
                    className="flex items-center justify-between gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
